...
public class LocalJwtAuthenticationFilter implements GlobalFilter {
	...
	private boolean isAuthorized(String path, String method, String role) {
		...
		Map<String, Set<String>> roleRequirements = Map.ofEntries(
			...
			Map.entry("/api/shipping/{id} PATCH", Set.of("DVL_OFFICER", "HUB", "MASTER")),
			Map.entry("/api/shipping/order/{orderId} DELETE", Set.of("HUB", "MASTER")),
			Map.entry("/api/shipping/exists/{uuid} GET", Set.of("ALL")),
			Map.entry("/api/shipping/delivery-notification-data/{orderId} GET", Set.of("ALL")),
			Map.entry("/api/shipping-agent POST", Set.of("HUB", "MASTER")),
			Map.entry("/api/shipping-agent/{shippingManagerId} GET", Set.of("DVL_OFFICER", "HUB", "MASTER")),
			Map.entry("/api/shipping-agent/search GET", Set.of("DVL_OFFICER", "HUB", "MASTER")),
			Map.entry("/api/shipping-agent/info-update PATCH", Set.of("HUB", "MASTER")),
			Map.entry("/api/shipping-agent/transit-update/{shippingManagerId} PATCH", Set.of("DVL_OFFICER", "HUB", "MASTER")),
			Map.entry("/api/shipping-agent/user/{shippingManagerId} DELETE", Set.of("HUB", "MASTER")),
